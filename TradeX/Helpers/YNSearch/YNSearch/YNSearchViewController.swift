...
open class YNSearchViewController: UIViewController, UITextFieldDelegate {
    ...
    open func ynSearchinit(_ topMargin:CGFloat = 20) {
        self.ynSearchTextfieldView = YNSearchTextFieldView(frame: CGRect(x: 20, y: topMargin, width: width-40, height: 50))
        ...
        let searchViewTopMargin = topMargin + self.ynSearchTextfieldView.frame.size.height
        self.ynSearchView = YNSearchView(frame: CGRect(x: 0, y: searchViewTopMargin, width: width, height: height-searchViewTopMargin))
